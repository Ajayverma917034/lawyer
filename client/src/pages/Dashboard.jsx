import { AddCircle, ArrowCircleRightOutlined, GavelOutlined, NotificationsActiveOutlined, TaskOutlined } from "@mui/icons-material";
...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="px-3 md:px-22 lg:px-28 py-3 bg-wihite-light min-h-screen">
      <h1 className=" text-2xl md:text-3xl mt-5 md:mt-3">Welcome Ajay Verma</h1>
        ...
        <div className="flex flex-col p-4 bg-white shadow-md rounded-md min-w-[18rem] h-[23rem]">
          ...
          <div className="flex flex-col justify-center items-center h-full">
            ...
            <div className="flex justify-end">
              <button className="font-md font-medium text-sm">See All Task <ArrowCircleRightOutlined className="text-sm text-blue"/></button>
            </div>
        </div>
        <div className="flex flex-col p-4 bg-white shadow-md rounded-md min-w-[18rem] h-[23rem]">
          <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col justify-center items-center h-full">
            ...
            <div className="flex justify-end">
              <button className="font-md font-medium text-sm">See All Mettings <ArrowCircleRightOutlined className="text-sm text-blue"/></button>
            </div>
        </div>
        <div className="flex flex-col p-4 bg-white shadow-md rounded-md min-w-[18rem] h-[23rem]">
          <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col justify-center items-center h-full">
            ...
            <div className="flex justify-end">
              <button className="font-md font-medium text-sm">See All Reminders <ArrowCircleRightOutlined className="text-sm text-blue"/></button>
            </div>
        </div>
        <div className="flex flex-col p-4 bg-white shadow-md rounded-md min-w-[18rem] h-[23rem]">
          <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col justify-center items-center h-full">
            ...
            <div className="flex justify-end">
              <button className="font-md font-medium text-sm">See All cases <ArrowCircleRightOutlined className="text-sm text-blue"/></button>
            </div>
        </div>
        <div className="flex flex-col p-4 bg-white shadow-md rounded-md min-w-[18rem] h-[23rem]">
          <div className="flex justify-between items-center">
          ...
          <img src={lawbook} alt="Meeting" className="w-[6rem] h-[6rem]"/>
            ...
            <div className="flex justify-end">
              <button className="font-md font-medium text-sm">See All Hearings <ArrowCircleRightOutlined className="text-sm text-blue"/></button>
            </div>
        </div>
      ...
      <div className="px-4 py-8 sm:p-8 rounded-md shadow-md bg-white mt-10 overflow-x-auto">
        ...
        <table class="table-auto w-full">
          ...
          <div className="flex justify-between mt-3 items-center">
            <p className="text-base sm:text-xl font-semibold">Show 0 out of 0 entries</p>
            <div className="flex">
              <button className="p-2 bg-wihite-light border border-gray-light rounded-tl-md rounded-bl-md">Previous</button>
              <button className="p-2 bg-wihite-light border border-gray-light rounded-tr-md rounded-br-md">Next</button>
            </div>
          </div>
      </div>
    ...
    <table className="table-auto w-full">
        ...
        <tbody className="text-gray-700 bg-wihite-light">
            ...
            <tr className="border-b border-gray">
                ...
                <td className="px-4 py-2">Duis aute irure dolor in reprehenderit.</td>
            </tr>
        </tbody>
    </table>
    <div className="flex justify-between mt-3 items-center">
