...
import { MatterHeader, TimeEntriesItem } from "../../../components/matter/matter-details/MatterDetailsComponent";
...
const TimeEntriesContract = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-[22rem] grid grid-cols-1 1374px:grid-cols-3 overflow-y-auto">
        <div className=" col-span-1 lg:col-span-2 border-r border-gray-light">
          <div className="min-h-[30rem] w-full overflow-x-auto bg-white border-t-0 border-b-1 border-gray-light">
            <table className="table-auto w-full">
              <thead className="border-b border-gray-light">
                <tr>
                  <th class="px-4 py-2 font-normal text-start">Data</th>
                  <th class="px-4 py-2 font-normal text-start">User </th>
                  ...
                  <th class="px-4 py-2 font-normal text-start">Billable</th>
                  <th class="px-4 py-2 font-normal text-start">
                    Discription
                  </th>
                  <th class="px-4 py-2 font-normal text-start">
          ...
          <div className="flex w-full items-center gap-6 px-8 pt-8 border-t border-gray-light bg-white flex-wrap bottom-0">
            <div className="flex gap-5 max-sm:w-full max-sm:justify-between">
              <div  className=" text-xl">Page 1 of 1</div>
...
export default TimeEntriesContract;
