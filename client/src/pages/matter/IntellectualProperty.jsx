      ...
      <div className="w-full bg-white-light min-h-screen">
        <div className="px-4 md:px-28 pt-2 items-center">
          <div className="flex gap-2 mt-5 flex-wrap">
            <h1 className="text-[18px] md:text-2xl">Intellectual Property</h1>
            <select
              name="filter"
              id="filter"
          ...
          <table className="table-auto w-full">
            <thead className="border-b border-gray-light">
              <tr>
                ...
                <th className="px-4 py-2 font-medium text-left">Subject</th>
                <th className="px-4 py-2 font-medium text-left">
                  Intellectual Property Rights
                </th>
                <th className="px-4 py-2 font-medium text-left">IP Class</th>
                <th className="px-4 py-2 font-medium text-left">
                  IP Subcategory
                </th>
                <th className="px-4 py-2 font-medium text-left">IP Status</th>
