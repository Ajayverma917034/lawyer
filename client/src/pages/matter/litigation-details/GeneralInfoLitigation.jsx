    ...
    <div className="grid grid-cols-1 1374px:grid-cols-3 min-h-screen overflow-y-auto">
      <div className=" col-span-1 lg:col-span-2 border-r border-gray-light ">
          ...
          <div className="flex flex-col gap-2 px-10 py-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-7">
              <SelectField
                ...
                options={stageOptions}
              />
              <InputField label="Value (INR)" value="200000" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-7">
              <InputField label="Judgement Value (INR)" value="0" />
              <InputField label="Judgement Value (INR)" value="200000" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-7">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-7">
              <InputField label="Opponent (1)" value="A & B Company" />
              <SelectField
            ...
            <div className="grid">
              <p className="flex gap-1 text-blue items-center font-medium cursor-pointer">
                <IoAdd /> Add another opponent
              </p>
            </div>
        ...
        <div className="pb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 px-10 md:px-10 py-3 items-center justify-center">
            <div className="flex flex-col">
              <h3 className=" text-xl font-semibold">Company</h3>
              <p className="font-normal">A & B Company</p>
            </div>
            <div className="flex flex-col">
              <h3 className=" text-xl font-semibold">External Advisor</h3>
              <p className="font-normal">Harshit Kaushal</p>
            </div>
            <div className="flex flex-col">
              <h3 className=" text-xl font-semibold">Rate per hour</h3>
          ...
          <div className="flex px-10 md:px-10 py-3 gap-x-5">
            <button className="btn-light bg-white text-blue border-2 border-blue font-semibold">
              Add
            </button>
            <button className="btn-light bg-white text-blue border-2 border-blue font-semibold">
              Save
        ...
        <div className="pb-10">
          <MatterHeader title="Related Contributors" />
          <div className="grid grid-cols-2 md:grid-cols-6 px-10 md:px-10 py-3 items-center justify-center">
            <div className="flex flex-col">
              <h3 className=" text-xl font-semibold">Person</h3>
              <p className="font-normal">Harshit</p>
            </div>
            <div className="flex flex-col">
              <h3 className=" text-xl font-semibold">Role</h3>
              <p className="font-normal">Tester</p>
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              <h3 className=" text-xl font-semibold">Added On</h3>
              <p className="font-normal">100.00</p>
            </div>
            <div className="flex flex-col">
              <div className="flex gap-x-3">
...
export default GeneralInfoLitigation;
